...
$(call inherit-product-if-exists, vendor/elephone/P2000/P2000-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/elephone/P2000/overlay

LOCAL_PATH := device/elephone/P2000
